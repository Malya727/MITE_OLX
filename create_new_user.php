                    ...
                    <div class="panel-body">
                        <form name="myform" onsubmit="return validateForm();" role="Form" method="post" action="#" accept-charset="UTF-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pnumber" class="form-control" name="pnumber" placeholder="Enter Phone Number">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-success btn-lg" id="submitbtn" name="submit">Create</button>
                            </div>
                            <div>
                                <center><a class="forgot" href="get_started.php">Already Have Account?<br /> Sign In</a></center>
                            </div>
                        </form>
                    </div>
                </div>
